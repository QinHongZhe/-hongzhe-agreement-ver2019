...
public class ReferencePathList {
  ...
  public static Vector<ReferencePath> per_decode(boolean align, InputStream in) throws IOException {
    return (Vector<ReferencePath>)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = MsgFrame.type(1507481);
  
  public static final AsnConverter CONV = (AsnConverter)new VectorConverter((AsnConverter)ReferencePath.CONV);
}
